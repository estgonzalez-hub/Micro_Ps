...
//Seven_segment module for e155 lab 1. Combinational logic where it takes switch inputs and generates
//the corresponding hexadecimal on the segment display.
